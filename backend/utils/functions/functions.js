...
import { setUserType } from "../../config.js";
...
const userChange = {
  name: "角色切换",
  description: "用户可以提供需要的的相关信息，比如切换姐姐，切换妹妹，切换哥哥。你可以提供指定的用户关键词语，来精准检索到目标。",
  parameters: {
    type: "object",
    properties: {
      username: {
        type: "string",
        description: "关键词，比如 姐姐，妹妹，哥哥"
      }
    },
    required: ["username"]
  },
  ...
  handler: async (params) => {
    ...
    if (username == '姐姐') {
      setUserType(1)
      return `hello 你找我有什么事情吗 哈哈哈，真好啊`
    } else if (username == '哥哥') {
      setUserType(2)
      return `做兄弟在心中，有事电话打不通，你找我什么事吗`

    } else if (username == '妹妹') {
      setUserType(0)
      return `你好我是小右，你终于找我啦嘻嘻嘻`
